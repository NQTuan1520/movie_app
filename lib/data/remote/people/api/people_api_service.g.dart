...
class _PeopleApiService implements PeopleApiService {
  ...
  Future<PageResponse<List<ActorResponse>>> getPopularPeople(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PageResponse<List<ActorResponse>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PageResponse<List<ActorResponse>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<ActorResponse>(
                  (i) => ActorResponse.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
